...
pattern_existing = "Автори публiкації:"
pattern_non_existing = "абра кадабра)"


text_1 = open("article1.txt", "r", encoding="utf-8").read()
text_2 = open("article2.txt", "r", encoding="utf-8").read()
